/**
 */
package org.yazgel.hermes.provider;
...
/**
 * This is the item provider adapter for a {@link org.yazgel.hermes.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_superEntity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_superEntity_feature", "_UI_Entity_type"),
				 HermesPackage.Literals.ENTITY__SUPER_ENTITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HermesPackage.Literals.ENTITY__ANNOTATIONS,
				 true,
				 false,
				 false,
