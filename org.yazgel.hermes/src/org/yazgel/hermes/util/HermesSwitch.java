 ...
 * @generated
 */
public class HermesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case HermesPackage.NAMED_ELEMENT: {
	 ...
	 * @generated
	 */
	public T casePackage(org.yazgel.hermes.Package object) {
		return null;
	}
