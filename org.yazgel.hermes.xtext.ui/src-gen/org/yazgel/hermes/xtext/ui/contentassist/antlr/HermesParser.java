		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityAccess().getAnnotationsAssignment_1_0(), "rule__Entity__AnnotationsAssignment_1_0");
					...
					put(grammarAccess.getEntityAccess().getFeaturesAssignment_6_0(), "rule__Entity__FeaturesAssignment_6_0");
					put(grammarAccess.getEntityAccess().getFeaturesAssignment_6_1(), "rule__Entity__FeaturesAssignment_6_1");
					put(grammarAccess.getReferenceAccess().getAnnotationsAssignment_1_0(), "rule__Reference__AnnotationsAssignment_1_0");
					put(grammarAccess.getReferenceAccess().getAnnotationsAssignment_1_1(), "rule__Reference__AnnotationsAssignment_1_1");
					put(grammarAccess.getReferenceAccess().getNameAssignment_3(), "rule__Reference__NameAssignment_3");
					put(grammarAccess.getReferenceAccess().getReferenceAssignment_4(), "rule__Reference__ReferenceAssignment_4");
					put(grammarAccess.getReferenceAccess().getManyAssignment_5(), "rule__Reference__ManyAssignment_5");
					put(grammarAccess.getDataTypeAccess().getAnnotationsAssignment_1_0(), "rule__DataType__AnnotationsAssignment_1_0");
